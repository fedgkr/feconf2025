      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
        ...
        <motion.div
          ...
          whileHover={{
            y: -8,
            boxShadow:
              '0 20px 40px rgba(255, 255, 255, 0.1), 0 0 30px rgba(255, 255, 255, 0.05)',
          }}
        ...
        >
          ...
          <div className="mb-8">
            <Button
              ...
              onClick={() => {
                window.open(
                  'https://www.ticketa.co/events/10',
                  '_blank',
                  'noopener,noreferrer'
                );
              }}
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3">
              <img
                src="/images/icons/ic-check.png"
                alt="check"
                className="w-5 h-5 flex-shrink-0"
              />
              <span className="text-gray-300 text-sm">
                {t('공식 세션 참여', 'Official session participation')}
              </span>
            </div>
            <div className="flex items-center gap-3">
              <img
              ...
              />
              <span className="text-gray-300 text-sm">
                {t('라이트닝 톡 참여', 'Lightning talk participation')}
              </span>
            </div>
            <div className="flex items-center gap-3">
              <img
              ...
              <button
                ...
                onClick={() => {
                  const networkingSection =
                    document.getElementById('section-networking');
                  if (networkingSection) {
                    networkingSection.scrollIntoView({
                      behavior: 'smooth',
                      block: 'start',
                    });
                  }
            ...
            <div className="flex items-center gap-3">
              ...
              >
                {t(
                  '토스 개발자와의 Private 네트워킹 신청권',
                  'Toss developer private networking application'
                )}
                <svg
                  className="w-3 h-3 ml-1"
                  fill="none"
        ...
        >
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-3">
              ...
              />
              <span className="text-gray-300 text-sm">
                {t('패널과의 네트워킹', 'Networking with panelists')}
              </span>
            </div>
            <div className="flex items-center gap-3">
              <img
              ...
              <span className="text-gray-300 text-sm">
                {t(
                  '우선 입장 (별도 레인)',
                  'Priority entrance (separate lane)'
                )}
              </span>
            </div>
          </div>
      ...
      <motion.div className="mt-8 p-6 md:p-6 rounded-xl bg-gray-900/30 backdrop-blur-md border border-gray-800 max-w-4xl mx-auto">
        ...
        <ul className="text-sm text-gray-300 space-y-2">
          ...
          <li>
            •{' '}
            {t(
              '골드 티켓은 한정 수량으로 판매됩니다.',
              'Gold tickets are sold in limited quantities.'
            )}
          </li>
          <li>
            •{' '}

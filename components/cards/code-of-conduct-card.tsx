...
export default function CodeOfConductCard({ theme }: CodeOfConductCardProps) {
  ...
  const conductItems = [
    ...
    },
    {
      ...
      content: {
        kr: "참여자의 다양한 배경과 커뮤니케이션을 방해하는 요소가 될 수 있습니다. 도움을 요청하기 전에 먼저 도움을 주고 자신의 생각을 자유롭게 표현할 수 있는 FEConf가 될 수 있도록 노력해 주세요.",
        en: "Participants' diverse backgrounds can become barriers to communication. Please help others first before asking for help, and strive to make FEConf a place where everyone can freely express their thoughts.",
      },
    },
    {
      title: {
    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-6">
        {conductItems.map((item, index) => (
          ...
          >
            <h4 className="text-xl font-bold text-white mb-4" style={{ fontWeight: "700" }}>

  ...
  return (
    <div className="fixed inset-0 bg-black z-50 flex flex-col items-center justify-center">
      <div className="relative w-32 h-32">
        ...
        />
        <div
          className="absolute inset-4 border-2 border-t-primary/80 border-r-primary/40 border-b-primary/20 border-l-primary/5 rounded-full animate-spin-reverse"
      ...
      {/* Loading text */}
      <div className="mt-8 text-center opacity-0" style={{ animation: "fadeIn 0.5s ease-out 0.5s forwards" }}>
        <p
      ...
      >
        <p>INITIALIZING 3D ENVIRONMENT // LOADING ASSETS // PREPARING INTERFACE</p>
